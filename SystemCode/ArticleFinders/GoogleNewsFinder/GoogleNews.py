### This module is edited on top of 
...
class GoogleNews:
    ...
    def __init__(self,lang="en",period="",start="",end="",encode="utf-8",region=None,page_size=100):
        self.__texts = []
        self.__links = []
        self.__results = []
        self.__totalcount = 0
    ...
    def page_at(self, page=1):
        ...
        try:
            if self.__start != "" and self.__end != "":
                ...
                self.url = "https://www.google.com/search?q={}&lr=lang_{}&biw=1920&bih=976&source=lnt&&tbs=lr:lang_1{},cdr:1,cd_min:{},cd_max:{},sbd:1&tbm=nws&start={}&num={}".format(self.__key,self.__lang,self.__lang,self.__start,self.__end,(self.__page_size * (page - 1)),self.__page_size)
                # print (self.url)
            elif self.__period != "":
                self.url = "https://www.google.com/search?q={}&lr=lang_{}&biw=1920&bih=976&source=lnt&&tbs=lr:lang_1{},qdr:{},,sbd:1&tbm=nws&start={}&num={}".format(self.__key,self.__lang,self.__lang,self.__period,(self.__page_size * (page - 1)),self.__page_size) 
            else:
                self.url = "https://www.google.com/search?q={}&lr=lang_{}&biw=1920&bih=976&source=lnt&&tbs=lr:lang_1{},sbd:1&tbm=nws&start={}&num={}".format(self.__key,self.__lang,self.__lang,(self.__page_size * (page - 1)),self.__page_size) 
    ...
    def get_page(self, page=1):
        ...
        try:
            if self.__start != "" and self.__end != "":
                ...
                self.url = "https://www.google.com/search?q={}&lr=lang_{}&biw=1920&bih=976&source=lnt&&tbs=lr:lang_1{},qdr:{},,sbd:1&tbm=nws&start={}&num={}".format(self.__key,self.__lang,self.__lang,self.__start,self.__end,(self.__page_size * (page - 1)),self.__page_size)
            else:
                self.url = "https://www.google.com/search?q={}&lr=lang_{}&biw=1920&bih=976&source=lnt&&tbs=lr:lang_1{},sbd:1&tbm=nws&start={}&num={}".format(self.__key,self.__lang,self.__lang,self.__start,self.__end,(self.__page_size * (page - 1)),self.__page_size)
        except AttributeError:
            raise AttributeError("You need to run a search() before using get_page().")
        try:
            result = self.build_response()
